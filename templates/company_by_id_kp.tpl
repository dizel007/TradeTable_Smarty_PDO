<div class="zagolovok">
       ...
       <tbody>
           <tr class="draw_inn">
             ...
             <td width="32">
             <a href="?id={$id}&inn={$company_arr[0]['inn']}&typeQuery=309#win309"><img src ="icons/table/plus.png"></a>
             </td>
             <td>Емайл</td>
             <td width="32">
             <a href="?id={$id}&inn={$company_arr[0]['inn']}&typeQuery=409#win409"><img src ="icons/table/plus.png"></a>
             </td>
...
{foreach $telephons_company as $value}
    ...
    <a href="?id={$id}&id_phone={$value['id']}&typeQuery=300#win300" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
              </td>
      </tr>
...
<a class = " link_tel {$act_email}" href="mailto:{$value['email']}"> {$value['email']}</a>
                              ...
                              <td width="70">
                               ...
                               <td width="30">
                     <a href="?id={$id}&id_email={$value['id']}&typeQuery=400#win400" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
                               </td>
                        </tr>
 </table>
