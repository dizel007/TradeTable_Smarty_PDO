...
// for ($j= 0; $j < 17; $j++) {
//   $temp =$sheet->getCellByColumnAndRow($j, $i_1)->getValue();
//   echo "--".$j."<b>Условия оплаты :".$temp."</b><br>";
// }
$p=1;
$temp_sum =0;
...
echo '<td>' . number_format($value['price'] * $value['kol']) . '</td>';
